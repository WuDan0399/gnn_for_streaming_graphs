...
if __name__ == '__main__':
    ...
    f = open(osp.join("examples", "theoretical", f"affected_{args.dataset}.txt"), "w")
    ...
    for batch_size, num_sample in zip(batch_sizes, num_samples):
        ...
        frontier = [0 for _ in depths]
        total = [0 for _ in depths]
        ...
        # for data_dir in data_folders:
            ...
            affected_nodes_sampled = affected_nodes_each_layer([init_out_edge_dict_sampled,
                                                               ...
                                                               direct_affected_nodes, depth=max_layer-1, self_loop=True)
