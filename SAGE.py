...
class SAGE(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, args) :
        ...
        self.convs.append(SAGEConv(in_channels, hidden_channels, aggr="min", save_intermediate=args.save_int))
        self.convs.append(SAGEConv(hidden_channels, out_channels, aggr="min", save_intermediate=args.save_int))
...
#         loader = data_loader(data, num_layers=2, num_neighbour_per_layer=25,
#                                   separate=False)
